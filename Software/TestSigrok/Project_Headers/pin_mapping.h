...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: I2C0_SCL             = PTB2 (D15)                     */  { PortBInfo,  GPIOB_BasePtr,  2,       PORT_PCR_MUX(2)|defaultPcrValue  },
         /*   1: I2C0_SDA             = PTB3 (D14)                     */  { PortBInfo,  GPIOB_BasePtr,  3,       PORT_PCR_MUX(2)|defaultPcrValue  },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   3: SPI0_PCS0            = PTC4 (D7)                      */  { PortCInfo,  GPIOC_BasePtr,  4,       PORT_PCR_MUX(2)|defaultPcrValue  },
         /*   4: SPI0_PCS1            = --                             */  { NoPortInfo, 0,         UNMAPPED_PCR, 0 },
         /*   5: SPI0_PCS2            = PTC2 (D10)                     */  { PortCInfo,  GPIOC_BasePtr,  2,       PORT_PCR_MUX(2)|defaultPcrValue  },
   ...
   static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
      ...
      enablePortClocks(PORTC_CLOCK_MASK|PORTD_CLOCK_MASK);
#endif
      PORTC->GPCLR = pcrValue|PORT_PCR_MUX(2)|PORT_GPCLR_GPWE(0x0014UL);
   ...
   static void clearPCRs() {
      ...
      enablePortClocks(PORTC_CLOCK_MASK|PORTD_CLOCK_MASK);
#endif
      PORTC->GPCLR = PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x14U);
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: UART1_TX             = PTE0 (D1)                      */  { PortEInfo,  GPIOE_BasePtr,  0,       PORT_PCR_MUX(3)|defaultPcrValue  },
         /*   1: UART1_RX             = PTE1 (D0)                      */  { PortEInfo,  GPIOE_BasePtr,  1,       PORT_PCR_MUX(3)|defaultPcrValue  },
 ...
 *  PTB0                     | -                                           | A5/ACC_SCL                | Accelerometer SCL       
 *  PTB1                     | -                                           | A4/ACC_SDA                | Accelerometer SDA       
 *  PTB2                     | I2C0_SCL                                    | D15                       | -       
 *  PTB3                     | I2C0_SDA                                    | D14                       | -       
 ...
 *  PTC2                     | SPI0_PCS2                                   | D10                       | LCD_backlight       
