...
//    * @return Reference to self
//    */
//   FormattedIO  &writeln(const void *value, Radix radix=Radix_16) {
...
//
    ...
    * @return Reference to self
    */
   FormattedIO  &writeln(long value, Radix radix=Radix_10) {
      write(value, radix);
      return writeln();
   }
    ...
    * @return Reference to self
    */
   FormattedIO  &write(unsigned value, Radix radix=Radix_10) {
      return write((unsigned long)value, radix);
   }
    ...
    * @return Reference to self
    */
   FormattedIO  &writeln(unsigned value, Radix radix=Radix_10) {
      return writeln((unsigned long)value, radix);
   }
    ...
    * @return Reference to self
    */
   FormattedIO  &write(int value, Radix radix=Radix_10) {
    ...
    * @return Reference to self
    */
   FormattedIO   &writeln(int value, Radix radix=Radix_10) {
    ...
    * @return Reference to self
    */
   FormattedIO  &writeln(float value) {
...
//
    ...
    * @note Skips leading whitespace
    */
   FormattedIO  &readln(unsigned long &value, Radix radix=Radix_10) {
      read(value, radix);
      return readln();
   }
    ...
    * @note Skips leading whitespace
    */
   FormattedIO  &read(long &value, Radix radix=Radix_10) {
      unsigned long temp;
      read(temp, radix);
      value = temp;
      return *this;
    ...
    * @note Skips leading whitespace
    */
   FormattedIO  &readln(long &value, Radix radix=Radix_10) {
      read(value, radix);
      return readln();
   }
    ...
    * @note Skips leading whitespace
    */
   FormattedIO  &read(unsigned int &value, Radix radix=Radix_10) {
      unsigned long temp;
      read(temp, radix);
      value = temp;
      return *this;
    ...
    * @note Skips leading whitespace
    */
   FormattedIO  &readln(unsigned &value, Radix radix=Radix_10) {
      read(value, radix);
      return readln();
   }
    ...
    * @note Skips leading whitespace
    */
   FormattedIO  &read(int &value, Radix radix=Radix_10) {
      long temp;
      read(temp, radix);
      value = temp;
      return *this;
    ...
    * @note Skips leading whitespace
    */
   FormattedIO  &readln(int &value, Radix radix=Radix_10) {
      read(value, radix);
      return readln();
   }
   ...
   void writeArray(T *data, uint32_t size, uint32_t visibleIndex=0) {
      ...
      for (unsigned index=0; index<size; index++) {
         if (needNewline) {
            setWidth(8);
            write((unsigned long)(visibleIndex+index*sizeof(T)), Radix_16).write(": ");
         }
         if (index<offset) {
            switch(sizeof(T)) {
               case 1  : write("   ");       break;
