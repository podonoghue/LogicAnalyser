...
xst -ifn xst.scr
move DigitalClockManager_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DigitalClockManager_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DigitalClockManager_exdes.ucf DigitalClockManager_exdes

echo 'Running map'
map -timing -pr b DigitalClockManager_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm DigitalClockManager_exdes -w routed.ncd routed.vhd
cd ..
